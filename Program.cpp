...
// Admin: Username = Bahaa , password=111
// Customer: Username = Mostafa , password=222
...
string GetCurrentTimeDate() {	// src: overflow.com/questions/17223096/outputting-date-and-time-in-c-using-stdchrono
